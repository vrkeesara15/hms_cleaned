    ...
    <div class="main-body">
      ...
      <nav aria-label="breadcrumb" class="main-breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Manage Line Type</li>
        </ol>
      </nav>
      <!-- /Breadcrumb -->
      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="btn-group btn-group-sm mb-3" role="group">
            <a href="<?php echo base_url();?>LineTypes/addLineTypes"><button type="button" class="btn btn-light has-icon"><i class="material-icons mr-1">add_circle_outline</i> Add</button></a>        
          </div>
        <?php } ?>
             ...
             <!--  <caption class="p-0 text-right"><small>Showing 1 to 5 of 57 entries</small></caption> -->
              ...
              <tbody>
                ...
                <tr id='delete_<?php echo $value->linetype_id;?>'>
                  <td> <?php echo $i; ?></td>
                  <td><?php echo $value->linetype_name;?></td>
                  <td><?php echo $value->type_name;?></td>
                  <td><?php 
                  if($value->invoice_type == 1){
                      echo "Notice Charges";
                      
                  }else if($value->invoice_type == 2){
                      echo "Invoice";
                  }else if($value->invoice_type == 3){
                      echo "Expenses";
                  }
                  ?></td>
                  <td class="text-center">
                    <div class="btn-group btn-group-xs" role="group">                     
                      <a href="<?php echo base_url(); ?>LineTypes/editLinetype/<?php echo $value->linetype_id;  ?>"  class="btn btn-link btn-icon bigger-130 text-success" ><i data-feather="edit"></i></a></div>
                  </td>
                </tr>
               <?php $i++; }  }  else { ?>
