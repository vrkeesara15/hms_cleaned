      ...
      <div class="card">
        <div class="card-body">
         ...
         <div class="row row-cols-10 row-cols-sm-10 row-cols-md-10">
            <div class="col">
                <br />
                <span style="float: left;">Invoice No : <?php echo $contractor_charges->contractor_invoice_id; ?></span><br/>
                <span style="float: left;">From,</span><span style="float: right;">Date : <?php echo Date('d M Y'); ?></span><br />
                <address class="font-size-sm">
                <span style="float: left;">Name : <?php echo $employeeDetails->fname.' '.$employeeDetails->lname; ?></span><span style="float: right;">Ref Invoice No : <?php echo $invoice_id; ?></span><br>
