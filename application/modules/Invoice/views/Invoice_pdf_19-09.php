  ...
  <tr>
    <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td style="font-family:Verdana, Geneva, sans-serif; font-weight:600; font-size:13px; border-top:1px solid #333; border-bottom:1px solid #333; border-right:1px solid #333; border-right:1px solid #333;" width="7%" align="center">SGST </td>
        ...
        <td style="font-family:Verdana, Geneva, sans-serif; font-weight:600; font-size:13px; border-top:1px solid #333; border-bottom:1px solid #333; border-right:1px solid #333;" width="10%" align="center">Commission Charges</td>
        <td style="font-family:Verdana, Geneva, sans-serif; font-weight:600; font-size:13px; border-top:1px solid #333; border-bottom:1px solid #333; border-right:1px solid #333; border-right:1px solid #333;" width="9%" align="center">SGST </td>
        <?php } ?>
    ...
    <td style="font-family:Verdana, Geneva, sans-serif; font-weight:300; font-size:13px;" colspan="2">
     ...
     Account No: 37883058699, IFSC: SBIN0061790,Anjaneya Nagar,Hyderabad.
      <?php if($idetails->vendor_no !='' &&  $idetails->vendor_no !='NULL'){?>Vendor ID: <?php echo $idetails->vendor_no;}?>
       ...
       <img src="<?php echo base_url(); ?>assets/images/signature4.png" width=''>
