        ...
        <div class="card-body">
         ...
         <div class="row row-cols-10 row-cols-sm-10 row-cols-md-10">
          ...
          <div class="d-flex flex-column flex-sm-row mt-3">
            ...
            /* if($userRole == 1){
                if($invoice_details[0]->download_status == 'y'){ ?>
                 <a class="btn btn-primary has-icon ml-sm-auto mt-1 mt-sm-0" type="button" target="_blank" href="<?php echo base_url(); ?>assets/invoices/<?php echo $invoice_details[0]->pdf_file; ?>">
                  <i class="mr-2" data-feather="download"></i>Download PDF
                </a>
                    
              <?php }else{ ?>
                    <a class="btn btn-primary has-icon ml-sm-auto mt-1 mt-sm-0" type="button" href="<?php echo base_url(); ?>Invoice/changeDownloadStatus/<?php echo $idetails->id; ?>">
                      <i class="mr-2" data-feather="download"></i>Verify Download
                    </a>
            <?php  }  ?>
