    ...
    <div class="main-body">
      ...
      <nav aria-label="breadcrumb" class="main-breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="<?php echo base_url();?>Notices/finalNotice">Notices</a></li>
      ...
      <div class="card">
        <div class="card-body">
          ...
          <!-- Toolbar -->         
          <div class="btn-group btn-group-sm mb-3" role="group">
           <a href="<?php echo base_url();?>Notices/addFinalNotice"><button type="button" class="btn btn-light has-icon"><i class="material-icons mr-1">add_circle_outline</i> Add</button></a>       
          </div>
            ...
            <table class="table table-bordered table-sm has-checkAll mb-0" data-bulk-target="#bulk-dropdown" data-checked-class="table-warning" id="example">
              ...
              <thead class="thead-primary">               
                <tr>
                    ...
                    <th scope="col">Telugu News Paper Name</th>
                    <th scope="col">English News Paper Name</th>
                    <th scope="col">New Paper Publication Date</th>
              ...
              <tbody>
                ...
                foreach($notices as $value){ ?>
                  ...
                  <td><?php echo  $value->telugu_news_paper; ?></td>
                  <td><?php echo  $value->english_news_paper; ?></td>
                  <td><?php echo  $value->news_publication_date; ?></td>
                  
                  <td><button class="btn btn-icon text-info" type="button">
                     <a href="<?php echo base_url(); ?>Notices/finalNoticeView/<?php echo $value->id; ?>"><i data-feather="eye"></i></a></button>
                  </td>
                    
                    <td class="text-center" >
                      <a href="<?php echo base_url(); ?>Notices/generateFinalNoticePDF/<?php echo $value->id; ?>"><i data-feather="download"></i></a></button>
                  
                      <div class="btn-group btn-group-xs" role="group">
                        <a href="<?php echo base_url(); ?>Notices/addFinalNotice/<?php echo $value->id;  ?>" class="btn btn-link btn-icon bigger-130 text-success"><i data-feather="edit"></i></a>
                      </div>
                    </td>
                  </tr>
