    ...
    <div class="main-body">
      ...
      <nav aria-label="breadcrumb" class="main-breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="<?php echo base_url();?>Loans">Notices</a></li>
      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="btn-group btn-group-sm mb-3" role="group">
           <a href="<?php echo base_url();?>Notices/addFirstNotice"><button type="button" class="btn btn-light has-icon"><i class="material-icons mr-1">add_circle_outline</i> Add</button></a>       
          </div>
            ...
            <table class="table table-bordered table-sm has-checkAll mb-0" data-bulk-target="#bulk-dropdown" data-checked-class="table-warning" id="example">
              ...
              <thead class="thead-primary">               
                <tr>
                    ...
                    <th scope="col">Irregular Amount</th>
              ...
              <tbody>
                ...
                foreach($notices as $value){ ?>
                  ...
                  <td><?php echo number_format($value->approved_amount, 2); ?></td>
                  <td><?php echo date('d M Y', strtotime($value->approval_date)); ?></td>
                  <td><?php echo number_format($value->irregular_amount, 2); ?></td>
                  <td><button class="btn btn-icon text-info" type="button">
                    <a href="<?php echo base_url(); ?>Notices/firstNoticeView/<?php echo $value->id; ?>"><i data-feather="eye"></i></a></button>
                  </td>
                    
                    <td class="text-center" >
                        <button class="btn btn-icon text-info" type="button">
                        <a href="<?php echo base_url(); ?>Notices/generateFirstNotesPDF/<?php echo $value->id; ?>"><i data-feather="download"></i></a>
                        </button>
                      <div class="btn-group btn-group-xs" role="group">
                        <a href="<?php echo base_url(); ?>Notices/addFirstNotice/<?php echo $value->id;  ?>" class="btn btn-link btn-icon bigger-130 text-success"><i data-feather="edit"></i></a>
                      </div>
                    </td>
                  </tr>
