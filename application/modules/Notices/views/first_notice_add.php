...
<link rel="stylesheet" href="<?php echo assets_url(); ?>new/plugins/flatpickr/flatpickr.min.css">
    ...
    <div class="main-body">
      ...
      <nav aria-label="breadcrumb" class="main-breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="<?php echo base_url();?>Notices">Generate First Notice</a></li>
  ...
  <section id="section4" class="mt-2">
            ...
            <div class="card">
              <div class="card-body">
                 <form action="<?php echo base_url().'Notices/insertFirstNotice'; ?>" name="firstnotice_submit" id="firstnotice_submit" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control datepicker-input" name="approval_date" id="approval_date" placeholder="Approval Date" value="<?php if($action == 'edit'){ if(!empty($loandata->approval_date)){ echo $loandata->approval_date; }else if($loandata->date_of_sanction!='0000-00-00'){ echo $loandata->date_of_sanction; } } ?>">
                        <span class="small" id="approval_date_error" style="color:red;"></span>
                      </div>
                    </div>
