...
<link rel="stylesheet" href="<?php echo assets_url(); ?>new/plugins/flatpickr/flatpickr.min.css">
    ...
    <div class="main-body">
      ...
      <nav aria-label="breadcrumb" class="main-breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="<?php echo base_url();?>Notices">Second Notice</a></li>
          <li class="breadcrumb-item active" aria-current="page">Add Second Notice</li>
        </ol>
      </nav>
      <!-- /Breadcrumb -->
  ...
  <section id="section4" class="mt-2">
            <h5>Create Second Notice Form</h5>
           
            <div class="card">
              <div class="card-body">
                 <form action="<?php echo base_url().'Notices/insertSecondNotice'; ?>" name="secondnotice_submit" id="secondnotice_submit" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-4">
                        <label for="first_notice_date">First Notice Date</label>
                        <input type="text" class="form-control datepicker-input" name="first_notice_date" id="first_notice_date" placeholder="First Notice Date" value="<?php if($action == 'edit'){ echo $loandata->first_notice_date; } ?>">
                        <span class="small" id="first_notice_date_error" style="color:red;"></span>
                      </div>
                      <div class="form-group col-md-4">
                        <label for="approval_date">NPA Date</label>
                        <input type="text" class="form-control datepicker-input" name="npa_date" id="npa_date" placeholder="NPA Date" value="<?php if($action == 'edit'){ echo $loandata->npa_date; } ?>">
