    ...
    <div class="main-body">
      ...
      <nav aria-label="breadcrumb" class="main-breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="<?php echo base_url();?>Notices/secondNotice">Notices</a></li>
          <li class="breadcrumb-item active" aria-current="page">Second Notice</li>
        </ol>
      </nav>
      <!-- /Breadcrumb -->
      <div class="card">
        <div class="card-body">
          ...
          <!-- Toolbar -->         
          <div class="btn-group btn-group-sm mb-3" role="group">
           <a href="<?php echo base_url();?>Notices/addSecondNotice"><button type="button" class="btn btn-light has-icon"><i class="material-icons mr-1">add_circle_outline</i> Add</button></a>       
          </div>
            ...
            <table class="table table-bordered table-sm has-checkAll mb-0" data-bulk-target="#bulk-dropdown" data-checked-class="table-warning" id="example">
              ...
              <thead class="thead-primary">               
                <tr>
                    ...
                    <th scope="col">First Notice Date</th>
              ...
              <tbody>
                ...
                foreach($notices as $value){ ?>
                  ...
                  <td><?php echo date('d M Y', strtotime($value->npa_date)); ?></td>
                  <td><?php echo date('d M Y', strtotime($value->first_notice_date)); ?></td>
                  <td><button class="btn btn-icon text-info" type="button">
                    <a href="<?php echo base_url(); ?>Notices/secondNoticeView/<?php echo $value->id; ?>"><i data-feather="eye"></i></a></button>
                  </td>
                  <td><button class="btn btn-icon text-info" type="button">
                    <a href="<?php echo base_url(); ?>Notices/generateSecondNoticePDF/<?php echo $value->id; ?>"><i data-feather="download"></i></a></button>
                  
                      <div class="btn-group btn-group-xs" role="group">
                        <a href="<?php echo base_url(); ?>Notices/addSecondNotice/<?php echo $value->id;  ?>" class="btn btn-link btn-icon bigger-130 text-success"><i data-feather="edit"></i></a>
                      </div>
                    </td>
                  </tr>
