...
$('.getCreditNotePopup').on('click',function() {
    var thisval = $(this);
    alert(thisval.attr('credit_note_amount'));
    console.log(thisval.attr('credit_note_amount'));
    console.log(thisval.attr('credit_note_gst_amount'));
    console.log(thisval.attr('total'));
});
