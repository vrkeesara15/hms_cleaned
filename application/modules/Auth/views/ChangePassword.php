            ...
            <div class="card">
              <div class="card-body">
                 <?php
                  $url = current_url();
                    $attributes = array(
                                      'name' => 'changepassword_from',
                                      'id'=>'changepassword_from',
                                      'method'=>'post',
                                      'enctype'=>'multipart/form-data');
                     echo form_open($url, $attributes); 
                  ?>              
                  <div class="form-group row no-gutters">
                    <label for="firstNameLeft" class="col-3 col-sm-2 col-form-label">Old Password</label>
                    <div class="col">
                      <input type="text" class="form-control"  id="old_password" name="old_password"  placeholder="Enter Old Password">
                       <span class="small" id="old_password_error" style="color:red;"></span>
                    </div>
                  </div>
                  <div class="form-group row no-gutters">
 ...
 <script src="<?php echo assets_url(); ?>new/js/jquery.min.js"></script>
  ...
  <script type="text/javascript">
    $("#changepassword_from").on("submit",function(){
