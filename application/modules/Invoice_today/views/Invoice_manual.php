                  ...
                  <fieldset class="form-fieldset">
                    ...
                    <option value='' selected>Select Loan Type</option>
                     ...
                     <?php foreach ($loantypes as  $value) { ?>
                        <option value="<?=$value->type_id;?>" <?php if($action == 'edit'){  if($invoiceData->loan_type_id == $value->type_id){ echo "selected"; }  } ?>><?=$value->type_name;?></option>
                    <?php } ?>
                    ...
                    <span class="small" id="loan_type_error" style="color:red;"></span>
                      ...
                      <span class="small" id="invoice_type_error" style="color:red;"></span>
                       ...
                       <?php /* <div class="col-sm-2" id="recovery_div" <?php if($action == 'edit'){ if($invoiceData->loan_type_id == '1' && $invoiceData->invoice_type =='2'){ ?> style="display: block;" <?php } }else{ ?> style="display: none;" <?php } ?>>
                    ...
                    <?php if($action == 'add'){  ?>
                        <div class="col-sm-2" id="recovery_div"style="display: block;">
                          <label>Recovery Type:<span style="color: red">*</span></label>
                          <select class="custom-select" id="recovery_type" name="recovery_type">
                          <option value='' selected>Select Recovery Type</option>
                          <option value="release" <?php if($action == 'edit'){  if($invoiceData->recovery_type == 'release'){ echo "selected"; }  } ?>>Release</option>
                    ...
                    <?php  }  ?>
                        <?php if($action == 'edit'){ if($invoiceData->loan_type_id == '1' && $invoiceData->invoice_type =='2') { ?>
                    ...
                    <div class="row">  
                      ...
                      <label>Account Number:<span style="color: red">*</span></label>
                        <input  class="form-control form-control-sm" name="account" placeholder="Enter Number" id="account" <?php if($action == 'edit'){  ?> value="<?php if($action == 'edit'){ echo $invoiceData->account;  } ?> " <?php  } ?> <?php if($action == 'edit'){ echo 'readonly';  } ?>>
                        <span class="small" id="account_error" style="color:red;"></span> 
                    </div>
                      <!-- <div class="col-sm-3">
                        <label>Account Number:<span style="color: red">*</span></label>
                          <input type="text" class="form-control form-control-sm" name="account" placeholder="Enter Number" id="account" value="<?php if($action == 'edit'){ echo $invoiceData->account;  } ?> " <?php if($action == 'edit'){ echo 'readonly';  } ?>>
                          <span class="small" id="account_error" style="color:red;"></span> 
                      </div> -->
                      <div class="col-sm-3">
                    ...
                    <div class="row">
                      <div class="form-group col-md-4">                      
                        ...
                        <span class="small" id="invoice_files_error" style="color:red;"></span>
                      </div>
                      <?php if($action == 'edit') { ?>
                      <div class="form-group col-md-4"> 
...
$("#recovery_type").on("change",function(){
    ...
    if(loan_type_id =='1' && (recovery_type == 'release' || recovery_type == 'auction')) {
        ...
        $("#LoanTypeChangedValue").html("<h6>Files List</h6><ol><li>13/2 Notice <span style='color:red'>(Mandatory)</span></li><li>13/2 Serving Notice <span style='color:red'>(Mandatory)</span></li><li>13/2 Postal Slips$nbsp;<span style='color:red'>(Mandatory)</span></li><li>13/2 Serving Photos&nbsp;<span style='color:red'>(Mandatory)</span></li><li>News paper telugu&nbsp;<span style='color:red'>(Mandatory)</span></li><li>News paper english&nbsp;<span style='color:red'>(Mandatory)</span></li></ol>");
      } else if(loan_type_id =='5' && recovery_type == '13/2') {
        $("#LoanTypeChangedValue").html("<h6>Files List</h6><ol><li>13/2 Notice <span style='color:red'>(Mandatory)</span></li><li>13/2 Serving Notice <span style='color:red'>(Mandatory)</span></li><li>13/2 Postal Slips$nbsp;<span style='color:red'>(Mandatory)</span></li><li>13/2 Serving Photos&nbsp;<span style='color:red'>(Mandatory)</span></li><li>News paper telugu&nbsp;</li><li>News paper english&nbsp;</li></ol>");
