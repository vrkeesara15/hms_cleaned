                ...
                <?php } ?>
                 <?php } ?>
                  <fieldset class="form-fieldset">
                    ...
                    <div class="form-row">
                      <div class="form-group col-sm-6">
                        <label for="employer_id_card">Profile Photo</label>
                      ...
                      <div class="form-group col-sm-6">
                       <label for="employer_auth_letter">Authorization Letter</label>
                      ...
                      <div class="form-group col-sm-6">
                       <label for="employer_seal_format">Seal Format</label>
                      ...
                      <div class="form-group col-sm-6">
                       <label for="employer_dra_certificate">DRA Certificate</label>
                    ...
                    <div class="form-row">
                      <div class="form-group col-sm-6">
                        <label for="employee_aadhar_card">Signature</label>
                      ...
                      <div class="form-group col-sm-6">
                        <label for="employee_aadhar_card">Aadhar Card</label>
                      ...
                      <div class="form-group col-sm-6">
                       <label for="employee_pan_card">Pan Card</label>
                      ...
                      <div class="form-group col-sm-6">
                       <label for="employee_edu_certificate">Education Qualification Certificate</label>
                       ...
                       <div class="form-group col-sm-6">
                       <label for="employee_resume">Resume</label>
                       ...
                       <div class="form-group col-sm-6">
                       <label for="police_verification_certificate">Police Verification Certificate </label>
                       ...
                       <div class="form-group col-sm-6">
                       <label for="sbi_id_card">SBI ID Card</label>
                       ...
                       <div class="form-group col-sm-6">
                       <label for="company_id_card">Company ID Card</label>
                      ...
                      <div class="form-group col-sm-6">
                       <label for="indian_bank_id_card">Indian Bank ID Card</label>
                     ...
                     <div class="form-group col-sm-6">
                       <label for="punjab_national_bank_id_card">Punjab National Bank ID Card</label>
                     ...
                     <div class="form-group col-sm-6">
                       <label for="indian_overseas_bank_id_card">Indian Overseas Bank ID Card</label>
                     ...
                     <div class="form-group col-sm-6">
                       <label for="central_bank_of_india_id_card">Central Bank of India ID Card</label>
                     ...
                     <div class="form-group col-sm-6">
                       <label for="canara_bank_id_card">Canara Bank ID Card</label>
                     ...
                     <div class="form-group col-sm-6">
                       <label for="karur_vysya_bank_id_card">Karur Vysya Bank ID Card</label>
